...
| 4 | **Aprofunde** 📚 | "Em breve" (placeholder) | **Trilha de aprofundamento**: materiais complementares para a caminhada — livro, plano de leitura, vídeo, música, PDF para baixar (1 card por item). Não repetir versículos da apostila — apontar para fora. | É o espaço natural de aprofundamento; missional por apontar para fora da igreja. |
...
| Aprofunde | `aprofunde` | `[{ tipo, titulo, descricao, link, icon?, rotulo? }]` — trilha de aprofundamento (livro, plano, vídeo, música, PDF) |
